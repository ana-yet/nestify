  ...
  if (!sessionId) {
    return (
      <EmptyState
        ...
        action={
          <Link to="/dashboard/tenant/bookings" className="btn btn-primary-nestify">
            My Bookings
          </Link>
        }
      />
      ...
      >
        ...
        <div className="p-6 text-left space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <Link to="/dashboard/tenant/bookings" className="btn btn-primary-nestify flex-1">
              View My Bookings
            </Link>
            <Link to="/properties" className="btn btn-outline flex-1">
              Browse More
            </Link>
          </div>
        </div>
