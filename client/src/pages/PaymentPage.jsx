  ...
  if (isError || !booking) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-4">
        ...
        <Link to="/dashboard/tenant/bookings" className="btn btn-primary-nestify mt-4">
          My Bookings
        </Link>
      </div>
    );
      ...
      <div className="bg-surface rounded-xl border border-border-subtle shadow-ambient overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link to="/dashboard/tenant/bookings" className="btn btn-outline flex-1">
              My Bookings
            </Link>
            <Link to={`/properties/${property?._id}`} className="btn btn-ghost flex-1">
              Back to Property
            </Link>
          </div>
        </div>
