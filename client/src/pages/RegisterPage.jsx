...
const RegisterPage = () => {
  const { register: registerUser, loginWithGoogle, isAuthenticated, user, loading: authLoading } =
    useAuth();
  ...
  return (
    ...
    >
      <div className="bg-surface rounded-xl border border-border-subtle shadow-ambient p-8">
        <h1 className="text-2xl font-bold text-text-main mb-2">Create your account</h1>
        <p className="text-text-muted mb-8">Join Nestify as a tenant or property owner</p>
