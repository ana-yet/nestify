...
const BookingRequestsPage = lazy(
  () => import("../pages/owner/BookingRequestsPage.jsx"),
);
const AddPropertyPage = lazy(
  () => import("../pages/owner/AddPropertyPage.jsx"),
);
const MyPropertiesPage = lazy(
  () => import("../pages/owner/MyPropertiesPage.jsx"),
);
const EditPropertyPage = lazy(
  () => import("../pages/owner/EditPropertyPage.jsx"),
);
...
const AdminTransactionsPage = lazy(
  () => import("../pages/admin/AdminTransactionsPage.jsx"),
);
const AdminEditPropertyPage = lazy(
  () => import("../pages/admin/AdminEditPropertyPage.jsx"),
);
...
const AppRoutes = () => {
  return (
    <BrowserRouter>
      <Suspense
        fallback={<LoadingSpinner fullScreen message="Loading page..." />}
      >
        <Routes>
          ...
          <Route element={<PrivateRoute />}>
            ...
            >
              ...
              />
              <Route
                path="dashboard/owner/edit-property/:id"
